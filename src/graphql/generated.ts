...
export type CrateSubscribeMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CrateSubscribeMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CrateSubscribeDocument = gql`
    mutation CrateSubscribe($name: String!, $email: String!) {
  createSubscriber(data: {name: $name, email: $email}) {
    id
  }
}
    `;
export type CrateSubscribeMutationFn = Apollo.MutationFunction<CrateSubscribeMutation, CrateSubscribeMutationVariables>;

/**
 * __useCrateSubscribeMutation__
 *
 * To run a mutation, you first call `useCrateSubscribeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCrateSubscribeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [crateSubscribeMutation, { data, loading, error }] = useCrateSubscribeMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCrateSubscribeMutation(baseOptions?: Apollo.MutationHookOptions<CrateSubscribeMutation, CrateSubscribeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CrateSubscribeMutation, CrateSubscribeMutationVariables>(CrateSubscribeDocument, options);
      }
export type CrateSubscribeMutationHookResult = ReturnType<typeof useCrateSubscribeMutation>;
export type CrateSubscribeMutationResult = Apollo.MutationResult<CrateSubscribeMutation>;
export type CrateSubscribeMutationOptions = Apollo.BaseMutationOptions<CrateSubscribeMutation, CrateSubscribeMutationVariables>;
